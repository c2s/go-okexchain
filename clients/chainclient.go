...
func (ec *Client) SendTransaction(ctx context.Context, tx *types.Transaction) (hexutil.Bytes, error) {
...
// func (ec *Client) SendTransaction(ctx context.Context, tx *types.Transaction) (result interface{}, err error) {
// 	data, err := tx.MarshalBinary()
// 		var result hexutil.Bytes
// 	if err != nil {
// 		return nil, err
// 	}
// 	result, err = ec.c.CallContext(ctx, nil, "eth_sendRawTransaction", hexutil.Encode(data))
// 	return result, err
// }
